...
LABEL description="This is VTTP5 SSF day 13 lecture demo"
LABEL name="vttp5-ssf-day13l"
...
ENTRYPOINT ["java", "-jar", "target/vttp5_ssf_day13l-0.0.1-SNAPSHOT.jar","--server.port=${SERVER_PORT}"]
